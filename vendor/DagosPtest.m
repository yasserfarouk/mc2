function [DP,P,X2,df] = DagosPtest(X,alpha)
...
if P >= alpha;
   DP=1;%disp('The sampled population is normally distributed.');
else
   DP=0;%disp('The sampled population is not normally distributed.');
end
